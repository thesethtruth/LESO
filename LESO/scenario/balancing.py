...
def merit_order(components, merit_order_dict, start_date):
    """
        Given a component list this function checks each components merit_tag and
        and interprets this based on the merit_order dictionary to form a merit balance. 
