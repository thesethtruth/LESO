...
run_id = 120821
*_, df1 = load_ema_leso_results(run_id=run_id, results_folder=RESULTS_FOLDER)
subsection = df1[df1["Li-ion EES installed capactiy"] > 3]
file_to_inspect1 = subsection[subsection.battery_cost_factor == subsection.battery_cost_factor.max()].filename_export.iat[0]
...
run_id = 120901
*_, df2 = load_ema_leso_results(run_id=run_id, results_folder=RESULTS_FOLDER)
file_to_inspect2 = df2[df2.battery_cost_factor == df2.battery_cost_factor.min()].filename_export.iat[0]
